...
\end{flushleft}
\vspace*{0.2cm}
\VAR{load_file(root, "covid19", "covid19.tex")}
\clearpage
...
% D \& I
%%%%%%%%%%%%%
\setheaders{D\&I Events and Initiatives}{D\&I Events and Initiatives}
\chapter{D\&I Events and Initiatives}
\VAR{load_file(root, "affinity_workshops", "affinity_workshops.tex")}
\clearpage
...
% Logo
%%%%%%%%%%%%%%
\setheaders{EMNLP 2022 Logo}{EMNLP 2022 Logo}
\chapter{EMNLP 2022 Logo}
\VAR{load_file(root, "logo_design", "logo_design.tex")}
\newpage
